...
procedure TfrmUsuarioVsAcoes.grdAcoesDblClick(Sender: TObject); // no duplo click no campo grid das ações ele muda de ativo pra inativo ou true pra false
...
begin
  If not QryAcoes.FieldByName('ativo').AsBoolean  then // se não estiver ativo coloca uma cor de fundo vermelha, caso contrário mantém
  begin
